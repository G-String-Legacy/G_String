...
The purpose of this site is to work (and ultimately publish) a detailed documentation on the latest version of G_String_L that should help future users to deal with software problems, once the creator of the software is no longer able to do so.
