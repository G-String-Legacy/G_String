...
public class SampleSizeView extends TextField {
	...
	public SampleSizeView(SampleSizeTree _myTree, char _cFacet, Integer _iFacet, Integer _iCounter,
		...
		// stub for future focus based extension
		/*
		 * this.focusedProperty().addListener((obs, oldf, newf) -> { if ((newf
		 * == true) && (oldf == false)) System.out.println("Gained Focus"); else
		 * if ((newf == false) && (oldf == true))
