...
Becoming a member is free and easy: first you [create a personal account with GitHub](https://docs.github.com/en/get-started/signing-up-for-github/signing-up-for-a-new-github-account), then you [send an email with your HitHub username](mailto:ralph@papaworx.com?subject=Membership in G-String-Legacy). You will then receive an invitation to join our platform. That's all there is to it.
