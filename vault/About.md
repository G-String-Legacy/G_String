...
**GS_L**, like this whole project is [Open Source](Open Source.md). That means not only that the software is free, and the code is in the public domain, but it also means that the onus for sustaining open source projects lies implicitly on the user community.
