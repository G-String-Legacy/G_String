...
<div style = {text-align:middle}><img src = "img/button.png">The upper right corner of the screen shows two buttons.  When you click on the three dots, you are offered a choice: <img src = "img/choice.png">. Once you are done with that code, just use the usual browser 'left arrow' to return to the previous screen.</div>
